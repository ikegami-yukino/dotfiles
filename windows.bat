...
bitsadmin.exe /TRANSFER htmlget https://raw.githubusercontent.com/nvie/vim-flake8/master/autoload/flake8.vim
 C:\Users\%USER%\.vim\autoload\flake8.vim 
...
bitsadmin.exe /TRANSFER htmlget https://raw.githubusercontent.com/nathanaelkane/vim-indent-guides/master/autoload/color_helper.vim
 C:\Users\%USER%\.vim\autoload\color_helper.vim 
